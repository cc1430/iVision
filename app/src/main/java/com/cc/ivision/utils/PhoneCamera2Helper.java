...
public class PhoneCamera2Helper implements Handler.Callback{
     ...
     */
    private final static int EXECUTION_FREQUENCY = 60;
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            if (!App.isGestureDetectStarting) {
                image.close();
                return;
            }
                    ...
                    public void run() {
                        try {
                            ...
                            if (!TextUtils.isEmpty(base64)) {
                                EventBus.getDefault().post(new EventParamBean(base64));
                            }
                        }catch (Exception e) {
                            e.printStackTrace();
                        }
    ...
    private void setUpCameraOutputs() {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mPreviewSize = new Size(Constant.PREVIEW_WIDTH_NEW, Constant.PREVIEW_HEIGHT_NEW);
                //outputPreviewSize = new Size(Constant.CAMERA_WIDTH_NEW, Constant.CAMERA_HEIGHT_NEW);
                outputPreviewSize = new Size(Constant.PREVIEW_WIDTH_NEW, Constant.PREVIEW_HEIGHT_NEW);
...
//                mTextureView.setAspectRatio(mPreviewSize.getWidth(),mPreviewSize.getHeight());
    ...
    private void baiduGestureDetect(String base64) {
        ...
        mCameraHelperRequest.showBase64(access_token);
